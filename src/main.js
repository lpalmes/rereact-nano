...
function createElement(name, _, _$1) {
  return Rereact$RereactNano.element(/* record */[
  ...
  return Rereact$RereactNano.element(/* record */[
              ...
              /* render */(function () {
                  return Rereact$RereactNano.div(/* :: */[
                              ...
                              /* :: */[
                                Rereact$RereactNano.listToElement(List.map((function (name) {
...
if (match !== null) {
  Rereact$RereactNano.render(createElement$1("ReasonML BA", /* [] */0, /* () */0), match);
} else {
