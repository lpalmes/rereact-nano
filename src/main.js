/******/ ;(function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var Rereact$RereactNano = __webpack_require__(19)

      var component = Rereact$RereactNano.statelessComponent('Test')

      function createElement(name, _, _$1) {
        return Rereact$RereactNano.element(
          /* record */ [
            /* debugName */ component[/* debugName */ 0],
            /* render */ function() {
              return Rereact$RereactNano.h4(
                /* :: */ [
                  Rereact$RereactNano.stringToElement(name),
                  /* [] */ 0
                ],
                /* () */ 0
              )
      ...
      var component$1 = Rereact$RereactNano.statelessComponent('Sample')
      ...
      function createElement$1(name, _, _$1) {
        return Rereact$RereactNano.element(
          /* record */ [
            ...
            /* render */ function() {
              return Rereact$RereactNano.div(
                /* :: */ [
                  Rereact$RereactNano.h1(
                    /* :: */ [
                      Rereact$RereactNano.stringToElement(name),
                      /* [] */ 0
                    ],
                  ...
                  /* :: */ [
                    Rereact$RereactNano.listToElement(
                      List.map(
                        function(name) {
      ...
      if (match !== null) {
        Rereact$RereactNano.render(
          createElement$1('ReasonML BA', /* [] */ 0, /* () */ 0),
          match
        )
      } else {
        console.log('None dom found :(')
      }
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var Caml_obj = __webpack_require__(2)
      var Caml_sys = __webpack_require__(12)
      ...
      function open_out_gen(_, _$1, _$2) {
        return Caml_io.caml_ml_open_descriptor_out(
          Caml_missing_polyfill.not_implemented(
      ...
      function output_value(_, _$1) {
        return Caml_missing_polyfill.not_implemented(
      ...
      function open_in_gen(_, _$1, _$2) {
        return Caml_io.caml_ml_open_descriptor_in(
          Caml_missing_polyfill.not_implemented(
            'caml_sys_open not implemented by bucklescript yet\n'
          )
        )
      ...
      function unsafe_really_input(_, _$1, _ofs, _len) {
        while (true) {
          ...
          if (len <= 0) {
            ...
            var r = Caml_missing_polyfill.not_implemented(
              'caml_ml_input not implemented by bucklescript yet\n'
            )
            if (r) {
              _len = (len - r) | 0
      ...
      function input_line(chan) {
        ...
        var scan = function(_accu, _len) {
          while (true) {
            var len = _len
            var accu = _accu
            var n = Caml_missing_polyfill.not_implemented(
            ...
            if (n) {
              if (n > 0) {
                ...
                if (accu) {
                  ...
                  return build_result(
                    Caml_string.caml_create_string(len$1),
                    len$1,
                    /* :: */ [res, accu]
                  )
                } else {
              ...
              return build_result(
                Caml_string.caml_create_string(len),
                len,
                accu
              )
            } else {
        ...
        function caml_ml_output(oc, str, offset, len) {
          ...
          if (
            ...
            if (id < 0) {
              ...
              caml_ml_flush(oc)
              oc[/* buffer */ 0] =
                oc[/* buffer */ 0] + str$1.slice((id + 1) | 0)
              return /* () */ 0
            }
          }
        }
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var max_int = /* record */ [/* hi */ 134217727, /* lo */ 1]
      ...
      function asr_(x, numBits) {
        if (numBits) {
          ...
          if (numBits < 32) {
            ...
            return /* record */ [/* hi */ hi >= 0 ? 0 : -1, /* lo */ lo$1 >>> 0]
          }
        } else {
          return x
        }
      ...
      function compare(self, other) {
        var v = Caml_obj.caml_nativeint_compare(
          self[/* hi */ 0],
          other[/* hi */ 0]
        )
        if (v) {
          ...
          return Caml_obj.caml_nativeint_compare(
            self[/* lo */ 1],
            other[/* lo */ 1]
          )
        }
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      function stringToElement(value) {
        return /* Flat */ Block.__(0, [
          /* :: */ [/* String */ Block.__(0, [value]), /* [] */ 0]
        ])
      }

      function element(component) {
        return /* Flat */ Block.__(0, [
          /* :: */ [/* Component */ Block.__(1, [component]), /* [] */ 0]
        ])
      }

      function createDomElement(name, children, _) {
        return /* Nested */ Block.__(1, [/* Some */ [name], children])
      }

      function listToElement(elements) {
        return /* Nested */ Block.__(1, [/* None */ 0, elements])
      }

      function div(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['div'], param])
      }

      function h1(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['h1'], param])
      }

      function h2(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['h2'], param])
      }

      function h3(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['h3'], param])
      }

      function h4(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['h4'], param])
      }

      function h5(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['h5'], param])
      }

      function h6(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['h6'], param])
      }

      function span(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['span'], param])
      }

      function ul(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['ul'], param])
      }

      function li(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['li'], param])
      }

      function img(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['img'], param])
      }

      function button(param, _) {
        return /* Nested */ Block.__(1, [/* Some */ ['button'], param])
      }
